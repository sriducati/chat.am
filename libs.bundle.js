...
*/
    ...
    (function(root, factory) {
        if (typeof define === "function" && define.amd) {
            define("strophe-core", [ "strophe-sha1", "strophe-base64", "strophe-md5", "strophe-polyfill" ], function() {
    ...
    */
            sendIQ: function(elem, callback, errback, timeout) {
                ...
                var handler = this.addHandler(function(stanza) {
                    ...
                    if (from === expectedFrom || expectedFrom === null && (from === Strophe.getBareJidFromJid(fulljid) || from === Strophe.getDomainFromJid(fulljid) || from === fulljid)) {
                        acceptable = true;
                    }
                    if (!acceptable) {
                        throw {
 ...
 */
(function() {
    var Occupant, RoomConfig, XmppRoom, __hasProp = {}.hasOwnProperty, __bind = function(fn, me) {
        return function() {
...
Strophe.addConnectionPlugin("roster", {
    ...
    _updateItem: function(itemTag) {
        ...
        var groups = [];
        Strophe.forEachChild(itemTag, "group", function(group) {
